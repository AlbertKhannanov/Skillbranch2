...
class Bottombar @JvmOverloads constructor(
    ...
    init {
        ...
        binding.root.background = materialBg
    }
    ...
    private fun animateShowSearch() {
        ...
        va.doOnEnd { binding.bottomGroup.isVisible = false }
        va.start()
    }
    ...
    private fun animateHideSearch() {
        ...
        val va = ViewAnimationUtils.createCircularReveal(
            ...
            width,
            height / 2,
            hypot(width.toDouble(), height / 2.toDouble()).toFloat(),
            0f
        )
        va.doOnEnd { binding.reveal.isVisible = false }
        va.start()
    }
